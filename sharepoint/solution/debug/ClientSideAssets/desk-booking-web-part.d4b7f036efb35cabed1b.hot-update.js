...
var DeskBooking = function (props) {
    var context = props.context, deskMasterListTitle = props.deskMasterListTitle, deskBookingListTitle = props.deskBookingListTitle;
            ...
            switch (_b.label) {
                ...
                case 2:
                    ...
                    desksWithStatus = activeDesks.map(function (desk) {
                        ...
                        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__assign)((0,tslib__WEBPACK_IMPORTED_MODULE_7__.__assign)({}, desk), { displayStatus: isBooked ? _models_IModels__WEBPACK_IMPORTED_MODULE_4__.DeskDisplayStatus.Booked : _models_IModels__WEBPACK_IMPORTED_MODULE_4__.DeskDisplayStatus.Available, bookedByName: overlappingBooking === null || overlappingBooking === void 0 ? void 0 : overlappingBooking.bookerName });
                    });
    ...
    var loadYourBookings = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(function () { return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(void 0, void 0, void 0, function () {
        var validation, bookings, error_3;
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__generator)(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    return [4 /*yield*/, service.getBookingsByEmail(bookerEmail)];
                case 2:
                    bookings = _a.sent();
    ...
    var handleCancelBooking = function (booking) { return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(void 0, void 0, void 0, function () {
        ...
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__generator)(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(0,_utils_bookingRules__WEBPACK_IMPORTED_MODULE_5__.canCancelBooking)(booking, bookerEmail, currentUserEmail)) {
                        setErrorMessage('You can only cancel bookings under your email or those you created.');
                        return [2 /*return*/];
                    }
                    setActionInProgress(true);
                    setErrorMessage(undefined);
        ...
        react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_8__.Stack, { tokens: { childrenGap: 16 } },
            ...
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_8__.Stack, { tokens: { childrenGap: 12 } },
                react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_8__.Stack, { horizontal: true, wrap: true, verticalAlign: "center", tokens: { childrenGap: 12 } },
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_16__.Label, null, "Your bookings"),
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_15__.DefaultButton, { text: "Find my bookings", onClick: function () { return loadYourBookings(); }, disabled: loadingBookings || actionInProgress })),
                react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_9__.Text, { variant: "small", block: true }, "Use the selected booking type details above, then click Find my bookings to view or cancel reservations."),
                loadingBookings ? (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_17__.Spinner, { size: _fluentui_react__WEBPACK_IMPORTED_MODULE_18__.SpinnerSize.medium, label: "Loading your bookings..." })) : bookingsLoaded && yourBookings.length === 0 ? (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_10__.MessageBar, { messageBarType: _fluentui_react__WEBPACK_IMPORTED_MODULE_11__.MessageBarType.info }, "No bookings found for this email address.")) : bookingsLoaded ? (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: _DeskBooking_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].bookingList }, yourBookings.map(function (booking) { return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { key: booking.id, className: _DeskBooking_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].bookingRow },
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_8__.Stack, { horizontal: true, wrap: true, verticalAlign: "center", tokens: { childrenGap: 12 } },
                        ...
                        react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_8__.Stack.Item, null, (0,_utils_bookingRules__WEBPACK_IMPORTED_MODULE_5__.canCancelBooking)(booking, bookerEmail, currentUserEmail) && (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_15__.DefaultButton, { text: "Cancel", disabled: actionInProgress, onClick: function () { return handleCancelBooking(booking); } })))))); }))) : null))));
};
...
/***/ 62488:
/*!********************************************************!*\
  !*** ./lib/webparts/deskBooking/utils/bookingRules.js ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   canCancelBooking: () => (/* binding */ canCancelBooking),
/* harmony export */   hasConflictingBooking: () => (/* binding */ hasConflictingBooking),
/* harmony export */   normalizeEmail: () => (/* binding */ normalizeEmail),
/* harmony export */   validateBookerDetails: () => (/* binding */ validateBookerDetails),
/* harmony export */   validateBookingRequest: () => (/* binding */ validateBookingRequest)
/* harmony export */ });
/* harmony import */ var _models_IModels__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../models/IModels */ 36556);
/* harmony import */ var _dateTimeUtils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dateTimeUtils */ 86418);
...
function validateBookerDetails(details) {
...
function validateBookingRequest(request, options) {
    if ((options === null || options === void 0 ? void 0 : options.requireInternalPerson) && !request.bookerPersonId) {
        return { isValid: false, message: 'Please select an internal user.' };
    }
    var bookerValidation = validateBookerDetails({
    ...
    if (!(0,_dateTimeUtils__WEBPACK_IMPORTED_MODULE_1__.isToday)(request.bookingDate)) {
        return {
            isValid: false,
            message: 'Bookings can only be made for today.'
        };
    }
    if (!(0,_dateTimeUtils__WEBPACK_IMPORTED_MODULE_1__.isWeekday)(request.bookingDate)) {
        return {
            isValid: false,
            message: 'Desk booking is not available on weekends.'
        };
    }
    if (!(0,_dateTimeUtils__WEBPACK_IMPORTED_MODULE_1__.isWithinBusinessHours)(request.startTime, request.endTime)) {
        return {
            isValid: false,
...
function hasConflictingBooking(request, existingBookings) {
    return existingBookings.some(function (booking) {
        return booking.bookingStatus === _models_IModels__WEBPACK_IMPORTED_MODULE_0__.BookingStatus.Booked
            && booking.deskId === request.deskId
            && (0,_dateTimeUtils__WEBPACK_IMPORTED_MODULE_1__.isSameDate)(booking.bookingDate, request.bookingDate)
            && (0,_dateTimeUtils__WEBPACK_IMPORTED_MODULE_1__.timesOverlap)(request.startTime, request.endTime, booking.startTime, booking.endTime);
    });
}
function canCancelBooking(booking, bookerEmail, currentUserEmail) {
    var normalizedBookerEmail = normalizeEmail(bookerEmail);
    var normalizedCurrentUserEmail = normalizeEmail(currentUserEmail);
    return booking.bookingStatus === _models_IModels__WEBPACK_IMPORTED_MODULE_0__.BookingStatus.Booked
        && (normalizeEmail(booking.bookerEmail) === normalizedBookerEmail
            || normalizeEmail(booking.bookerEmail) === normalizedCurrentUserEmail
            || normalizeEmail(booking.createdByEmail) === normalizedCurrentUserEmail);
}
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("367d16b276cff5814d4f")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=desk-booking-web-part.d4b7f036efb35cabed1b.hot-update.js.map