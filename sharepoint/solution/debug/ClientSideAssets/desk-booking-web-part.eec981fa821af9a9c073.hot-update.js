...
/* harmony import */ var _fluentui_react__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @fluentui/react */ 80954);
/* harmony import */ var _fluentui_react__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! @fluentui/react */ 49885);
...
var DeskBooking = function (props) {
    ...
    var _d = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]), desks = _d[0], setDesks = _d[1];
    var _e = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]), yourBookings = _e[0], setYourBookings = _e[1];
    var _f = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false), bookingsLoaded = _f[0], setBookingsLoaded = _f[1];
    var _g = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(true), loading = _g[0], setLoading = _g[1];
    var _h = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false), loadingBookings = _h[0], setLoadingBookings = _h[1];
    var _j = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false), actionInProgress = _j[0], setActionInProgress = _j[1];
    var _k = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(undefined), errorMessage = _k[0], setErrorMessage = _k[1];
    var _l = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(undefined), successMessage = _l[0], setSuccessMessage = _l[1];
    var _m = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(undefined), internalPersonId = _m[0], setInternalPersonId = _m[1];
                ...
                case 2:
                    ...
                    desksWithStatus = activeDesks.map(function (desk) {
                        ...
                        var overlappingBooking = deskBookings.find(function (booking) {
                            return (0,_utils_dateTimeUtils__WEBPACK_IMPORTED_MODULE_6__.timesOverlap)(_utils_dateTimeUtils__WEBPACK_IMPORTED_MODULE_6__.FIXED_BOOKING_START_TIME, _utils_dateTimeUtils__WEBPACK_IMPORTED_MODULE_6__.FIXED_BOOKING_END_TIME, booking.startTime, booking.endTime);
                        });
            ...
            switch (_a.label) {
                case 0:
                    ...
                    request = {
                        ...
                        startTime: _utils_dateTimeUtils__WEBPACK_IMPORTED_MODULE_6__.FIXED_BOOKING_START_TIME,
                        endTime: _utils_dateTimeUtils__WEBPACK_IMPORTED_MODULE_6__.FIXED_BOOKING_END_TIME,
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("section", { className: _DeskBooking_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].deskBooking },
        react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_8__.Stack, { className: _DeskBooking_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].fullScreenStack, tokens: { childrenGap: 16 } },
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_8__.Stack, { tokens: { childrenGap: 4 } },
                ...
                react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_9__.Text, { variant: "medium", block: true }, "Select an internal user (People picker) to book for yourself or others, or enter external guest details. Bookings are for today only (9:00 AM \u2013 5:00 PM) on weekdays.")),
            ...
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_8__.Stack, { horizontal: true, wrap: true, tokens: { childrenGap: 16 }, verticalAlign: "end", className: _DeskBooking_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].filters },
                ...
                react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_8__.Stack.Item, { grow: 1, styles: { root: { minWidth: 180 } } },
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_13__.TextField, { label: "Start time", value: _utils_dateTimeUtils__WEBPACK_IMPORTED_MODULE_6__.FIXED_BOOKING_START_TIME, readOnly: true })),
                react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_8__.Stack.Item, { grow: 1, styles: { root: { minWidth: 180 } } },
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_13__.TextField, { label: "End time", value: _utils_dateTimeUtils__WEBPACK_IMPORTED_MODULE_6__.FIXED_BOOKING_END_TIME, readOnly: true })),
                react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_8__.Stack.Item, null,
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_14__.DefaultButton, { text: "Refresh", onClick: function () { return loadDesks(); }, disabled: loading || actionInProgress }))),
                ...
                !isBookingDay ? (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_10__.MessageBar, { messageBarType: _fluentui_react__WEBPACK_IMPORTED_MODULE_11__.MessageBarType.warning }, "Desk booking is only available on weekdays. Today is not a booking day.")) : loading ? (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_16__.Spinner, { size: _fluentui_react__WEBPACK_IMPORTED_MODULE_17__.SpinnerSize.large, label: "Loading desks..." })) : desks.length === 0 ? (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_10__.MessageBar, { messageBarType: _fluentui_react__WEBPACK_IMPORTED_MODULE_11__.MessageBarType.info },
                    ...
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_8__.Stack, { tokens: { childrenGap: 8 } },
                        ...
                        desk.displayStatus === _models_IModels__WEBPACK_IMPORTED_MODULE_4__.DeskDisplayStatus.Booked && desk.bookedByName && (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_9__.Text, { variant: "small", block: true },
                            ...
                            desk.bookedByName)),
                        react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_8__.Stack, { tokens: { childrenGap: 8 } },
                            react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_18__.PrimaryButton, { text: "Book", disabled: !isBookingDay
                            ...
                            isCurrentUserAdmin && (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_14__.DefaultButton, { text: "Cancel", disabled: desk.displayStatus !== _models_IModels__WEBPACK_IMPORTED_MODULE_4__.DeskDisplayStatus.Booked
            ...
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_8__.Stack, { tokens: { childrenGap: 12 } },
                react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_8__.Stack, { horizontal: true, wrap: true, verticalAlign: "center", tokens: { childrenGap: 12 } },
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_15__.Label, null, isCurrentUserAdmin ? 'Today\'s bookings' : 'Your bookings'),
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_14__.DefaultButton, { text: isCurrentUserAdmin ? 'Load today\'s bookings' : 'Find my bookings', onClick: function () { return loadYourBookings(); }, disabled: loadingBookings || actionInProgress })),
                    ...
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_8__.Stack, { horizontal: true, wrap: true, verticalAlign: "center", tokens: { childrenGap: 12 } },
                        react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_8__.Stack.Item, { grow: 1, styles: { root: { minWidth: 240 } } },
                            ...
                            react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_9__.Text, { block: true, variant: "small" },
                                ...
                                booking.bookerEmail,
                                ")")),
                        react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_8__.Stack.Item, null, renderStatusBadge(booking.bookingStatus))))); }))) : null))));
};
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("b5819e1dfdda3ee36c38")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=desk-booking-web-part.eec981fa821af9a9c073.hot-update.js.map