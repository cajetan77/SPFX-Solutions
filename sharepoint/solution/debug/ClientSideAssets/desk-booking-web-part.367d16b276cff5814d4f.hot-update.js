            ...
            pages: [
                {
                    ...
                    groups: [
                        ...
                        {
                            groupName: DeskBookingWebPartStrings__WEBPACK_IMPORTED_MODULE_5__.AdminGroupName,
                            groupFields: [
                ...
                !isBookingDay ? (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_10__.MessageBar, { messageBarType: _fluentui_react__WEBPACK_IMPORTED_MODULE_11__.MessageBarType.warning }, "Desk booking is only available on weekdays. Today is not a booking day.")) : loading ? (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_17__.Spinner, { size: _fluentui_react__WEBPACK_IMPORTED_MODULE_18__.SpinnerSize.large, label: "Loading desks..." })) : desks.length === 0 ? (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_10__.MessageBar, { messageBarType: _fluentui_react__WEBPACK_IMPORTED_MODULE_11__.MessageBarType.info },
                    ...
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_8__.Stack, { tokens: { childrenGap: 8 } },
                        ...
                        desk.displayStatus === _models_IModels__WEBPACK_IMPORTED_MODULE_4__.DeskDisplayStatus.Booked && desk.bookedByName && (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_9__.Text, { variant: "small", block: true },
                            "Booked by ",
                            desk.bookedByName)),
                        desk.displayStatus === _models_IModels__WEBPACK_IMPORTED_MODULE_4__.DeskDisplayStatus.Booked
                            && desk.activeBookingId
                            && isCurrentUserAdmin ? (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_15__.DefaultButton, { text: "Cancel booking", disabled: actionInProgress, onClick: function () { return handleCancelBooking({
...
/***/ 36556:
/*!****************************************************!*\
  !*** ./lib/webparts/deskBooking/models/IModels.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   DeskDisplayStatus: () => (/* binding */ DeskDisplayStatus)
/* harmony export */ });
var BookingStatus;
...
var DeskDisplayStatus;
(function (DeskDisplayStatus) {
    DeskDisplayStatus["Available"] = "Available";
    DeskDisplayStatus["Booked"] = "Booked";
    DeskDisplayStatus["Cancelled"] = "Cancelled";
})(DeskDisplayStatus || (DeskDisplayStatus = {}));
...
/* harmony export */   isBookingAdmin: () => (/* binding */ isBookingAdmin),
/* harmony export */   normalizeEmail: () => (/* binding */ normalizeEmail),
/* harmony export */   parseAdminEmails: () => (/* binding */ parseAdminEmails),
...
function canCancelBooking(booking, bookerEmail, currentUserEmail, isAdmin) {
    if (booking.bookingStatus !== _models_IModels__WEBPACK_IMPORTED_MODULE_0__.BookingStatus.Booked) {
        return false;
    }
    if (isAdmin) {
        return true;
    ...
    return normalizeEmail(booking.bookerEmail) === normalizedBookerEmail
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("ec734790f830340450c7")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=desk-booking-web-part.367d16b276cff5814d4f.hot-update.js.map