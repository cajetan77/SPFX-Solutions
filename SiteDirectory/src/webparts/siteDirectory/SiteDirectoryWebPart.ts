  ...
  public render(): void {
    const element: React.ReactElement<ISiteDirectoryProps> = React.createElement(
      SiteDirectory,
      {
        ...
        numberOfColumns: this.properties.numberOfColumns || 2
      }
    );
          ...
          groups: [
            {
              ...
              groupFields: [
                ...
                PropertyPaneDropdown('numberOfColumns', {
                  label: strings.NumberOfColumnsFieldLabel,
                  options: [
                    { key: 1, text: '1 Column' },
                    { key: 2, text: '2 Columns' }
                  ],
                  selectedKey: this.properties.numberOfColumns || 1
                })
              ]
            }
          ]
